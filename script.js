...
async function fetchNews(){
	...
	url = `https://newsapi.org/v2/everything?q=${category}&from=2022-02-15&sortBy=publishedAt&apiKey=9ad590cfaabc4b07903eea472c5e090d&page=${currentPage}&pagesize=${pagesize}`;
...
function controller(val){
	...
	url = `https://newsapi.org/v2/everything?q=tesla&from=2022-02-15&sortBy=publishedAt&apiKey=9ad590cfaabc4b07903eea472c5e090d&page=${currentPage}&pagesize=${pagesize}`;
		remove()
		fetchNews();
}
